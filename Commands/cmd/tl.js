...
module.exports = {
  ...
  run: async (client, message, args, secret, prefix, trans) => {
    ...
    var hastarlangInput = true,
      hasorilangInput = true;
    try {
      ...
      if (message.content.includes("tar:")) {
        if (message.content.includes("ori:")) {
          tarlangInput = message.content
            .split("tar:")[1]
            .split(" ")[1]
            .split(" ori:")[0];
          orilangInput = message.content
            .split("ori:")[1]
            .split(" ")[1]
            .split(" ")[0];
      ...
      let tarlang = hastarlangInput
        ? tarlangInput
        : svr_lang || message.guild.preferredLocale;
      ...
      const google_tl = trans.strings.find(
        (it) => it.name === "google_tl"
      ).trans;
      msg.edit(
